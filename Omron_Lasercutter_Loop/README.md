Hier ist die aktualisierte Version Ihrer README im Markdown-Format, angepasst an
die neue Projektstruktur inklusive der modularen MQTT-Schnittstelle
(mqtt_handler.py), dem automatischen Lade-Timeout und der detaillierten
Subprozess-Direktsteuerung.
